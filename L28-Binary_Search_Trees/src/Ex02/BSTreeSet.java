...
public class BSTreeSet<E extends Comparable<E>> {
    ...
    public boolean add(E element) {
        ...
        NodePair pair = findNodeAndParent(element);
        if(pair.node != null){
            return false;
        }
    ...
    public boolean contains(E element) {
        ...
        return findNodeAndParent(element).node != null;
    }
    ...
    private void printInorderHelper(Node node, StringBuilder sb){
        if(node.left != null) {
            printInorderHelper(node.left, sb);
        }
        sb.append(node.data).append(", ");
        if(node.right != null){
            printInorderHelper(node.right, sb);
        }
    }
